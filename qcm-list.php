        ...
        <div class="mb-qcm-item <?php echo $is_locked ? 'is-locked' : ''; ?>">
          ...
          <div class="mb-qcm-item-right">
            ...
            <?php elseif ( ! $is_logged_in ) : ?>
              <a class="mb-btn mb-btn-login" href="<?php echo esc_url( wp_login_url( get_permalink( $post->ID ) ) ); ?>">
                <?php esc_html_e( 'Se connecter', MB_TEXT_DOMAIN ); ?>
              </a>
            <?php else : ?>
              <a class="mb-btn mb-btn-start" href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>">
