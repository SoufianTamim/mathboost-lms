...
class MB_Shortcodes {
    ...
    public static function init() {
        ...
        add_shortcode( 'mathboost_register',        [ __CLASS__, 'register_block' ] );
    }
    ...
    public static function register_block( array $atts = [] ): string {
        ob_start();
        include MB_PLUGIN_DIR . 'frontend/templates/register.php';
        return ob_get_clean();
    }
}
